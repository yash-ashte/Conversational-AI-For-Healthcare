...
firebase_credentials = credentials.Certificate("Sample.json")
...
def get_feature_importance():
    ...
    try:
        ...
        # Upload the image to Firebase and get the signed URL
...
def explain_instance(instance_index):
    ...
    if instance_index is not None:
        try:
            # Convert index and get instance data
            ...
            # Upload to Firebase and get a signed URL
            image_url = upload_to_firebase(file_name)
...
def get_feature_impact(feature_name):
    ...
    if feature_name in X.columns:
        try:
            ...
            # Generate and save the SHAP dependence plot
